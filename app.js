...
app.use(express.json());  // needed for /mpesa/callback
...
// Locals — must be after passport so req.user is available
app.use((req, res, next) => {
    res.locals.success = req.flash("success");
    res.locals.error = req.flash("error");
    res.locals.currUser = req.user;
    res.locals.currentPath = req.originalUrl;  // ← was req.path
    next();
});

// Routes — all after locals middleware
app.get("/", (req, res) => {
...
app.use("/bookings", paymentsRouter);   // ← moved here
app.use("/mpesa", paymentsRouter);      // ← moved here
app.use("/", userRouter);
